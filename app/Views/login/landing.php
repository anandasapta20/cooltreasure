...
<div class="container my-4 justify-content-center">
    <div class="row">
        <div class="col align-self-center ps-5">
            ...
            <a href="/login/katalog" class="btn btn-1 btn-outline">Cek Katalog<img src="/Assets/icon/arrow-right.svg" alt="" class="icon ms-2"></a>
        </div>
        <div class="col">
...
<div class="container my-4 justify-content-center">
    <div class="row">
        ...
        <div class="col-sm align-self-center">
            ...
            <a href="/login/tentang" class="btn btn-1 btn-outline me-2 align-middle">Tentang Kami<img src="/Assets/icon/arrow-right.svg" alt="" class="icon ms-2"></a>
        </div>
    </div>
</div>
        ...
        <?php foreach ($jaket as $j) : ?>
            <div class="col">
                <div class="card h-100 text-center">
                    <a href="/login/detailJaket/<?= $j['id_jaket']; ?>"><img src="/Assets/fotojaket/<?= $j['foto_jaket']; ?>" class="rounded mx-auto my-3 d-block" width="270" alt="foto jaket"></a>
                    <div class="card-body pt-0">
                        <a href="/login/detailJaket/<?= $j['id_jaket']; ?>" class="card-detail">
                            <h5 class="card-title"><b><?= $j['nama_jaket']; ?></b></h5>
                            <p class="card-text mb-2"><?= $j['ukuran']; ?></p>
                            <a href="/login/detailJaket/<?= $j['id_jaket']; ?>" class="btn btn-2 card-harga">Rp <?= $j['harga']; ?></a>
                        </a>
                    </div>
                </div>
            </div>
...
<div class="container my-5">
    <div class="row justify-content-between">
        ...
        <div class="col-2 text-end align-middle">
            <a href="/login/semuaUlasan" class="btn btn-2">Lihat Semua<img src="/Assets/icon/arrow-right-main.svg" alt="" class="icon ms-2"></a>
        </div>
    </div>
    <div class="row">
